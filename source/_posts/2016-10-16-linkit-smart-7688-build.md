---
layout: post
title: 'linkit-smart-7688-build'
date: 2016-10-16 00:37:40
comments: true
tags:
  - OpenWRT
  - linkit-smart-7688
...
In the Ubuntu system, open the _Terminal_ application and type the following commands:
...
7. Prepare the kernel configuration to inform OpenWrt that we want to build an firmware for LinkIt Smart 7688:
   ...
   ** Select the options as below: ** - Target System: `Ralink RT288x/RT3xxx` - Subtarget: `MT7688 based boards` - Target Profile: `LinkIt7688`

   ![](/img/20161016/1.png)

   Save and exit (**<font color=red>use the deafult config file name without changing it</font>**)
