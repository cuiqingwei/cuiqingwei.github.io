...
[http://www.cnblogs.com/luopeng/p/4678704.html](http://www.cnblogs.com/luopeng/p/4678704.html)
...
#luci-app-arduino-webpanel-1.5.6 #http://arduino.cc/download.php?f=/luci-app-arduino-webpanel-1.5.6.tar.bz2
...
#http://blog.csdn.net/piggy1924/article/details/8557350 #http://wenku.baidu.com/link?url=evvS3AjpZeFeKQYHPw7_80UctmoG0uVmNqKpZO-PDRwRw8jOydDBVkFeOpCpukEhyKwcVPpoVFR-byD1VeNfzpSYpIsn_thKC_mudbA5xzO
配置编译OpenWRT
...
启动宿主机gdb
(这里要修复一个bug，方法是：cd <openwrtdir>/staging*dir/<targetarch>; rmdir lib; ln -s ../toolchain-<targetarch>*<gccver>/lib lib)。
